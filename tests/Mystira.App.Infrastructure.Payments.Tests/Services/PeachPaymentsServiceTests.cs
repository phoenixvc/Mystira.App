...
public class PeachPaymentsServiceTests
{
    ...
    public async Task ProcessPaymentAsync_OnSuccess_ReturnsSucceededStatus()
    {
        ...
        _mockHttp.When(HttpMethod.Post, "https://test.oppwa.com/v1/payments")
            .Respond("application/json", JsonSerializer.Serialize(new
            {
                id = "payment_12345",
    ...
    public async Task GetPaymentStatusAsync_ReturnsCorrectStatus()
    {
        ...
        _mockHttp.When(HttpMethod.Get, $"https://test.oppwa.com/v1/payments/{transactionId}*")
            .Respond("application/json", JsonSerializer.Serialize(new
            {
                id = transactionId,
                amount = "200.00",
    ...
    public async Task RefundPaymentAsync_OnSuccess_ReturnsSucceededStatus()
    {
        ...
        _mockHttp.When(HttpMethod.Post, "https://test.oppwa.com/v1/payments/pay_to_refund")
            .Respond("application/json", JsonSerializer.Serialize(new
            {
                id = "refund_123",
    ...
    public async Task RefundPaymentAsync_OnFailure_ReturnsFailedStatus()
    {
        ...
        _mockHttp.When(HttpMethod.Post, "https://test.oppwa.com/v1/payments/pay_invalid")
            .Respond("application/json", JsonSerializer.Serialize(new
            {
                id = "",
    ...
    public async Task RefundPaymentAsync_OnException_ReturnsFailedStatus()
    {
        ...
        _mockHttp.When(HttpMethod.Post, "https://test.oppwa.com/v1/payments/pay_network_error")
            .Throw(new HttpRequestException("Network error"));
    ...
    {
        // Arrange
        _mockHttp.When(HttpMethod.Get, "https://test.oppwa.com/v1/")
