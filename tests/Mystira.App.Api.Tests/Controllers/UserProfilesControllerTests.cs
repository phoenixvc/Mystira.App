...
public class UserProfilesControllerTests
{
    ...
    public async Task CreateProfile_WithValidRequest_ReturnsCreatedWithProfile()
    {
        ...
        var createdProfile = new UserProfile { Id = "profile-1", DisplayName = "Test Player" };
        ...
        returnedProfile.DisplayName.Should().Be("Test Player");
    }

    [Fact]
    public async Task CreateProfile_WhenArgumentException_ReturnsBadRequest()
    {
        // Arrange
        var request = new CreateUserProfileRequest { DisplayName = "Test" };
        ...
        errorResponse.Message.Should().Contain("Invalid profile data");
    }
    ...
    public async Task GetProfileById_WhenProfileExists_ReturnsOkWithProfile()
    {
        ...
        var profile = new UserProfile { Id = profileId, DisplayName = "Test Player" };
    ...
    public async Task UpdateProfile_WhenProfileExists_ReturnsOkWithUpdatedProfile()
    {
        ...
        var updatedProfile = new UserProfile { Id = profileId, DisplayName = "Updated Name" };
        ...
        var okResult = result.Result.Should().BeOfType<OkObjectResult>().Subject;
        var returnedProfile = okResult.Value.Should().BeOfType<UserProfile>().Subject;
        returnedProfile.DisplayName.Should().Be("Updated Name");
    }
    ...
    [Fact]
    public async Task UpdateProfile_WhenArgumentException_ReturnsBadRequest()
    {
        // Arrange
        var profileId = "profile-1";
        var request = new UpdateUserProfileRequest { DisplayName = "Invalid" };
    ...
    public async Task CreateMultipleProfiles_WithValidRequest_ReturnsOkWithProfiles()
    {
        ...
        {
            AccountId = "acc-1",
            DisplayNames = new List<string> { "Player 1", "Player 2" }
        };
        var profiles = new List<UserProfile>
        {
            new UserProfile { Id = "profile-1", DisplayName = "Player 1" },
