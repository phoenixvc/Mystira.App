...
public interface IApiClient
{
    ...
    Task<DomainGameSession?> StartGameSessionAsync(string scenarioId, string accountId, string profileId, List<string> playerNames, string targetAgeGroup);
    Task<DomainGameSession?> EndGameSessionAsync(string sessionId);
    Task<DomainGameSession?> ProgressSessionSceneAsync(string sessionId, string newSceneId);
    Task<List<DomainGameSession>?> GetSessionsByAccountAsync(string accountId);
