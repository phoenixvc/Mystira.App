...
ENVIRONMENT="prod" # ⚠️ UPDATE: Set to 'dev', 'staging', or 'prod'
RESOURCE_GROUP="prod-wus-rg-mystira" # ⚠️ UPDATE: Set your resource group name
LOCATION="westus" # ⚠️ UPDATE: Set your preferred Azure region
SUBSCRIPTION_ID="22f9eb18-6553-4b7d-9451-47d0195085fe" # ⚠️ UPDATE: Set your Azure subscription ID
...
DEPLOYMENT_NAME="$ENVIRONMENT-$LOCATION-app-mystira$(date +%Y%m%d-%H%M%S)"
